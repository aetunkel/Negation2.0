// Study1B: Known and unknown shown simultaneously. Switch condition with unknown repeated is first
...
// block 1
var trial1 = [unkArrayShuffle[6], knownArrayShuffle[5]];
shuffle(trial1);
allUnk.push(trial1);

var trial2 = [unkArrayShuffle[11], knownArrayShuffle[6]];
shuffle(trial2);
allUnk.push(trial2);

var trial3 = [unkArrayShuffle[8], knownArrayShuffle[7]];
shuffle(trial3);
allUnk.push(trial3);

var trial4 = [unkArrayShuffle[13], knownArrayShuffle[8]];
shuffle(trial4);
allUnk.push(trial4);

var trial5 = [unkArrayShuffle[10], knownArrayShuffle[9]];
shuffle(trial5);
allUnk.push(trial5);

var trial6 = [unkArrayShuffle[10], knownArrayShuffle[11]]
shuffle(trial6);
allUnk.push(trial6);

var trial7 = [unkArrayShuffle[10], knownArrayShuffle[13]]
shuffle(trial7);
allUnk.push(trial7);

unkArrayShuffle[10] = "<img src='img/"+ unkArray1[10] + ".jpg' class='image'>";
var trial8 = [knownArrayShuffle[10], unkArrayShuffle[10]];
shuffle(trial8);
allUnk.push(trial8);
...
var trial10 = [knownArrayShuffle[1], unkArrayShuffle[0]];
shuffle(trial10);
allKnown.push(trial10);

var trial11 = [knownArrayShuffle[3], unkArrayShuffle[2]];
shuffle(trial11);
allKnown.push(trial11);

var trial12 = [knownArrayShuffle[2], unkArrayShuffle[3]];
shuffle(trial12);
allKnown.push(trial12);

var trial13 = [knownArrayShuffle[4], unkArrayShuffle[5]];
shuffle(trial13);
allKnown.push(trial13);

var trial14 = [knownArrayShuffle[4], unkArrayShuffle[7]];
shuffle(trial14);
allKnown.push(trial14);

var trial15 = [knownArrayShuffle[4], unkArrayShuffle[9]];
shuffle(trial15);
allKnown.push(trial15);

knownArrayShuffle[4] = "<img src='img/"+ knownArray1[4] + ".jpg' class='image'>";
var trial16 = [unkArrayShuffle[4], knownArrayShuffle[4]];
shuffle(trial16);
