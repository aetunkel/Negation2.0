...
var trial1 = [unkArrayShuffle[7], unkArrayShuffle[8]];
shuffle(trial1);
allUnk.push(trial1);

var trial2 = [unkArrayShuffle[9], unkArrayShuffle[10]];
shuffle(trial2);
allUnk.push(trial2);

var trial3 = [unkArrayShuffle[11], unkArrayShuffle[12]];
shuffle(trial3);
allUnk.push(trial3);

var trial4 = [unkArrayShuffle[13], unkArrayShuffle[14]]; /// repeated trial
shuffle(trial4);
allUnk.push(trial4);

var trial5 = [unkArrayShuffle[15], unkArrayShuffle[16]];
shuffle(trial5);
allUnk.push(trial5);

var trial6 = [unkArrayShuffle[17], unkArrayShuffle[18]]
shuffle(trial6);
allUnk.push(trial6);

var trial7 = [unkArrayShuffle[19], unkArrayShuffle[20]]
shuffle(trial7);
allUnk.push(trial7);

unkArrayShuffle[14] = "<img src='img/"+ unkArray1[14] + ".jpg' class='image'>";
var trial8 = [unkArrayShuffle[22], unkArrayShuffle[14]];
shuffle(trial8);
allUnk.push(trial8);

// block 2
var trial9 = [knownArrayShuffle[1], unkArrayShuffle[0]];
shuffle(trial9);
allKnown.push(trial9);

var trial10 = [knownArrayShuffle[0], unkArrayShuffle[1]];
shuffle(trial10);
allKnown.push(trial10);

var trial11 = [knownArrayShuffle[2], unkArrayShuffle[3]];
shuffle(trial11);
allKnown.push(trial11);

var trial12 = [knownArrayShuffle[3], unkArrayShuffle[2]]; /// repeated trial
shuffle(trial12);
allKnown.push(trial12);


var trial13 = [knownArrayShuffle[5], unkArrayShuffle[4]];
shuffle(trial13);
allKnown.push(trial13);

var trial14 = [knownArrayShuffle[7], unkArrayShuffle[6]];
shuffle(trial14);
allKnown.push(trial14);

var trial15 = [knownArrayShuffle[4], unkArrayShuffle[5]];
shuffle(trial15);
allKnown.push(trial15);

unkArrayShuffle[2] = "<img src='img/"+ unkArray1[2] + ".jpg' class='image'>";
var trial16 = [unkArrayShuffle[2], knownArrayShuffle[6]];
shuffle(trial16);
