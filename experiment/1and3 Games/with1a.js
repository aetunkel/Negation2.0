...
// block 1
var trial1 = [knownArrayShuffle[1], unkArrayShuffle[0]]; // unk
shuffle(trial1);
allKnown.push(trial1);

var trial2 = [knownArrayShuffle[0], unkArrayShuffle[1]]; // kno
shuffle(trial2);
allKnown.push(trial2);

var trial3 = [knownArrayShuffle[2], unkArrayShuffle[3]]; // kno
shuffle(trial3);
allKnown.push(trial3);

var trial4 = [knownArrayShuffle[3], unkArrayShuffle[2]]; // unk
shuffle(trial4);
allKnown.push(trial4);


var trial5 = [knownArrayShuffle[4], unkArrayShuffle[5]]; // kno
shuffle(trial5);
allKnown.push(trial5);

var trial6 = [knownArrayShuffle[5], unkArrayShuffle[4]]; // unk
shuffle(trial6);
allKnown.push(trial6);

var trial7 = [knownArrayShuffle[7], unkArrayShuffle[6]]; /// repeated trial // unk
shuffle(trial7);
allKnown.push(trial7);

unkArrayShuffle[6] = "<img src='img/"+ unkArray1[6] + ".jpg' class='image'>"; // kno
var trial8 = [unkArrayShuffle[6], knownArrayShuffle[8]];
shuffle(trial8);
...
// control
var trial9 = [unkArrayShuffle[7], unkArrayShuffle[8]];
shuffle(trial9);
allUnk.push(trial9);

var trial10 = [unkArrayShuffle[9], unkArrayShuffle[10]];
shuffle(trial10);
allUnk.push(trial10);

var trial11 = [unkArrayShuffle[11], unkArrayShuffle[12]];
shuffle(trial11);
allUnk.push(trial11);

var trial12 = [unkArrayShuffle[13], unkArrayShuffle[14]]; 
shuffle(trial12);
allUnk.push(trial12);

// experimental
var trial13 = [unkArrayShuffle[15], unkArrayShuffle[16]];
shuffle(trial13);
allUnk.push(trial13);

var trial14 = [unkArrayShuffle[17], unkArrayShuffle[18]]
shuffle(trial14);
allUnk.push(trial14);

var trial15 = [unkArrayShuffle[19], unkArrayShuffle[20]] /// repeated trial // unk
shuffle(trial15);
allUnk.push(trial15);

unkArrayShuffle[20] = "<img src='img/"+ unkArray1[20] + ".jpg' class='image'>"; 
var trial16 = [unkArrayShuffle[22], unkArrayShuffle[20]]; 
shuffle(trial16);
allUnk.push(trial16);
