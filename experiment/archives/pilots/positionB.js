...
// version 1
// var trial1 = [knownArrayShuffle[1], unkArrayShuffle[0]];
// shuffle(trial1);
// allKnown.push(trial1);

// var trial2 = [knownArrayShuffle[0], unkArrayShuffle[1]];
// shuffle(trial2);
// allKnown.push(trial2);

// var trial3 = [knownArrayShuffle[0], unkArrayShuffle[3]];
// shuffle(trial3);
// allKnown.push(trial3);

// var trial4 = [knownArrayShuffle[0], unkArrayShuffle[5]];
// shuffle(trial4);
// allKnown.push(trial4);

// // experimental
// var trial5 = [knownArrayShuffle[3], unkArrayShuffle[2]];
// shuffle(trial5);
// allKnown.push(trial5);

// var trial6 = [knownArrayShuffle[2], unkArrayShuffle[7]];
// shuffle(trial6);
// allKnown.push(trial6);

// var trial7 = [knownArrayShuffle[5], unkArrayShuffle[4]];
// shuffle(trial7);
// allKnown.push(trial7);

// knownArrayShuffle[0] = "<img src='img/"+ knownArray1[0] + ".jpg' class='image'>";
// var trial8 = [unkArrayShuffle[6], knownArrayShuffle[0]];
// shuffle(trial8);
// allKnown.push(trial8);



// var trial9 = [unkArrayShuffle[9], knownArrayShuffle[4]];
// shuffle(trial9);
// allUnk.push(trial9);

// var trial10 = [unkArrayShuffle[8], knownArrayShuffle[7]];
// shuffle(trial10);
// allUnk.push(trial10);

// var trial11 = [unkArrayShuffle[8], knownArrayShuffle[9]];
// shuffle(trial11);
// allUnk.push(trial11);

// var trial12 = [unkArrayShuffle[8], knownArrayShuffle[11]];
// shuffle(trial12);
// allUnk.push(trial12);

// var trial13 = [unkArrayShuffle[11], knownArrayShuffle[6]];
// shuffle(trial13);
// allUnk.push(trial13);

// var trial14 = [unkArrayShuffle[10], knownArrayShuffle[13]]
// shuffle(trial14);
// allUnk.push(trial14);

// var trial15 = [unkArrayShuffle[13], knownArrayShuffle[8]]
// shuffle(trial15);
// allUnk.push(trial15);

// unkArrayShuffle[8] = "<img src='img/"+ unkArray1[8] + ".jpg' class='image'>";
// var trial16 = [knownArrayShuffle[10], unkArrayShuffle[8]];
// shuffle(trial16);
// allUnk.push(trial16);
...
var trial3 = [knownArrayShuffle[3], unkArrayShuffle[0]];
shuffle(trial3);
allKnown.push(trial3);

var trial4 = [knownArrayShuffle[5], unkArrayShuffle[0]];
shuffle(trial4);
allKnown.push(trial4);
...
var trial7 = [knownArrayShuffle[4], unkArrayShuffle[5]];
shuffle(trial7);
allKnown.push(trial7);

unkArrayShuffle[0] = "<img src='img/"+ unkArray1[0] + ".jpg' class='image'>";
var trial8 = [unkArrayShuffle[0], knownArrayShuffle[6]];
shuffle(trial8);
allKnown.push(trial8);



var trial9 = [unkArrayShuffle[4], knownArrayShuffle[9]];
shuffle(trial9);
allUnk.push(trial9);

var trial10 = [unkArrayShuffle[7], knownArrayShuffle[8]];
shuffle(trial10);
allUnk.push(trial10);

var trial11 = [unkArrayShuffle[9], knownArrayShuffle[8]];
shuffle(trial11);
allUnk.push(trial11);

var trial12 = [unkArrayShuffle[11], knownArrayShuffle[8]];
shuffle(trial12);
allUnk.push(trial12);

var trial13 = [unkArrayShuffle[6], knownArrayShuffle[11]];
shuffle(trial13);
allUnk.push(trial13);

var trial14 = [unkArrayShuffle[13], knownArrayShuffle[10]]
shuffle(trial14);
allUnk.push(trial14);

var trial15 = [unkArrayShuffle[8], knownArrayShuffle[13]]
shuffle(trial15);
allUnk.push(trial15);

knownArrayShuffle[8] = "<img src='img/"+ knownArray1[8] + ".jpg' class='image'>";
var trial16 = [knownArrayShuffle[8], unkArrayShuffle[10]];
shuffle(trial16);
allUnk.push(trial16);
